...
export function Profile() {
  return (
    ...
    <div className={style.profileDiv} id="ProfileInfo">
      <div className={style.fotoImgContainer} ><img className={style.fotoImg} src={fotoPerfil} alt="Foto de Perfil" /><span className={style.shadowImg}></span></div>
      ...
      <div className={style.infoContainer}>
        ...
        <div className={style.iconsContainer}>
          <img src={iconHtml5} alt="html5" className={style.stackIcons} title="Html5"/>
          <img src={iconCSS} alt="CSS3" className={style.stackIcons} title="CSS3"/>
          <img src={iconJS} alt="Javascript" className={style.stackIcons} title="Javascript"/>
          <img src={reactIcon} alt="React.js" className={style.stackIcons} title="React.js"/>
        </div>
      </div>
    </div>
